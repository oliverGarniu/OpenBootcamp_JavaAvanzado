...
public class BootcamperController {
    ...
    public Response addBootcamper(Bootcamper bootcamper) {
        Bootcamper existBootcamper = bootcamperService.addBootcamper(bootcamper);
        return existBootcamper == null ? Response.created(URI.create("/bootcampers/" + bootcamper.getName()))
